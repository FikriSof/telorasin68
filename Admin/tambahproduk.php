...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <h5 class="text-danger">Foto Produk Harus 2992 x 2992 pixels <br>
        Dengan Format .JPG/PNG</h5>
    </div>
    <div class="form-group">
        <label>Stok</label>
...
if (isset($_POST['save']))
{
    ...
    move_uploaded_file($lokasilokasifoto[0], "../img_produk/".$namanamafoto[0]);
    $koneksi->query("INSERT INTO produk
        (nama_produk,harga_produk,berat_produk,foto_produk,desc_produk,stok_produk,id_kategori)
    ...
    foreach ($namanamafoto as $key => $tiap_nama)
    {
        ...
        move_uploaded_file($tiap_lokasi, "../img_produk/".$tiap_nama);
